class BimbinganIndexModel {
  ...
  factory BimbinganIndexModel.fromJson(Map<String, dynamic> json) {
    return BimbinganIndexModel(
      internship:
          json['internship'] != null ? Internship.fromJson(json['internship']) : null,
...
class Instructor {
  ...
  Instructor({this.id, this.nama, this.nip, this.jenisKelamin, this.tempatLahir, this.tanggalLahir, this.alamat, this.hp, this.foto, this.createdAt, this.updatedAt});
