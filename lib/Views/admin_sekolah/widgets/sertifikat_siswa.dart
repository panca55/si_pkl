...
class SertifikatSiswa extends StatefulWidget {
  final int id;
  const SertifikatSiswa({super.key, required this.id});

  @override
  State<SertifikatSiswa> createState() => _SertifikatSiswaState();
}

class _SertifikatSiswaState extends State<SertifikatSiswa> {
  bool loading = true;
  @override
