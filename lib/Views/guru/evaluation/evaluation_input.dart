...
class EvaluationInput extends StatefulWidget {
  static const String routname = '/evaluation-input';
  final int internshipId;
  const EvaluationInput({super.key, required this.internshipId});

  @override
  State<EvaluationInput> createState() => _EvaluationInputState();
}

class _EvaluationInputState extends State<EvaluationInput> {
