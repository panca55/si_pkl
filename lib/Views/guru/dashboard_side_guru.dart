  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        if ((guru?.nama?.isEmpty ?? false) && (guru?.nip?.isEmpty ?? false)) {
          Future.microtask(() {
            if (mounted) {
        ...
        return Scaffold(
                ...
                ..._pages.keys.map((String pageName) {
                  return ListTile(
                    ...
                    leading: Icon(
                      ...
                      color:
                          _currentPage == pageName ? Colors.blue : Colors.grey,
                    ),
          ...
          body: Navigator(
            ...
            onGenerateRoute: (RouteSettings settings) {
              ...
              if (settings.name == EditProfileGuru.routeName) {
                page = EditProfileGuru(
