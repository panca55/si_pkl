class AssessmentsModel {
  ...
  String? message;
  AssessmentsModel({this.monitoring, this.message});
  ...
  factory Internship.fromJson(Map<String, dynamic> json) {
    return Internship(
      ...
      assessment: json['assessment'] != null
          ? (json['assessment'] as List)
              .map((assessment) => Assessment.fromJson(assessment as Map<String, dynamic>))
              .toList()
          : null,
    );
  }
