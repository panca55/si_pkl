...
import 'package:si_pkl/Views/instruktur/widgets/show_komentar_edit_popup.dart';
import 'package:si_pkl/Views/instruktur/widgets/show_komentar_popup.dart';
...
class DetailLogbook extends StatefulWidget {
  static const String routname = '/logbook-instruktur-detail';
  final int? logbookId;
                  ...
                  children: [
                    Consumer<DetailLogbookInstrukturProvider>(
                      ...
                      return _buildInfoCard(
                        ...
                        image:
                            '${BaseApi.studentImageUrl}/${logbookDataDetail?.fotoKegiatan}',
