...
Future<void> showEditJurusanPopup(
    {required BuildContext context, required Department department,required Function(String) onSubmit}) async {
  final GlobalKey<FormState> formKey = GlobalKey<FormState>();
  final TextEditingController nameController = TextEditingController();
  nameController.text = department.nama ?? '';
  showDialog(
    context: context,
