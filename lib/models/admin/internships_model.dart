class InternshipsModel {
  List<Internship>? internship;
  InternshipsModel({this.internship});
  factory InternshipsModel.fromJson(Map<String, dynamic> json) =>
      InternshipsModel(
        internship: json["internships"] is List
            ? (json["internships"] as List)
                .map(
                    (item) => Internship.fromJson(item as Map<String, dynamic>))
                .toList()
            : json["internships"] != null
