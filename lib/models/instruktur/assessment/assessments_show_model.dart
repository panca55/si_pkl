class AssessmentsShowModel {
  Internship? internship;
  List<Assessment>? assessment;
  AssessmentsShowModel({this.assessment, this.internship});
  factory AssessmentsShowModel.fromJson(Map<String, dynamic> json) {
    return AssessmentsShowModel(
      ...
      assessment: json['assessments'] != null
          ? (json['assessments'] as List)
              .map((assessment) =>
                  Assessment.fromJson(assessment as Map<String, dynamic>))
              .toList()
          : null,
    );
  }
...
class Assessment {
  ...
  factory Assessment.fromJson(Map<String, dynamic> json) {
    return Assessment(
      ...
      score: json['score'],
      deskripsiSoftSkill: json['deskripsi_soft_skill'],
